...
def main():
    ...
    config_files = ["config.yml", "config_1.yml", "config_K3pi_1.yml", "config_K3pi_2.yml"]
    ...
    signi, nlls, ndfs = cal_significance(config_files, res_files, base_res, test_res, loop=5)
